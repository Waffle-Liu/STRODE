...
# split_len = [int(0.9*opt.num_mnist_sample_train), int(0.1*opt.num_mnist_sample_train)]
# train_dataset, val_dataset = data.random_split(train_dataset, split_len, generator=torch.Generator().manual_seed(112))
